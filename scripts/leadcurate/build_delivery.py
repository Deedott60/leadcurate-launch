...
MARKET_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "tarrant-tx": {"display": "Tarrant County TX", "raw_dir": RAW_ROOT / "tarrant-tx", "raw_pattern": "tax-roll-extracted.csv", "lane_patterns": {"default": ["tax-roll-extracted.csv"], "tax-delinquent": ["tax-roll-extracted.csv", "tax-roll.zip"]}, "default_city": "Fort Worth", "state": "TX"},
    "jefferson-ky": {"display": "Jefferson County KY", "raw_dir": RAW_ROOT / "jefferson-ky", "raw_pattern": "parcels.csv", "lane_patterns": {"default": ["parcels.csv"], "code-violations": ["property-maintenance-violations-enriched.csv", "property-maintenance-violations.csv"], "liens": ["lien-holder-final-orders.csv"], "pre-foreclosure": ["property-foreclosures.csv"]}, "default_city": "Louisville", "state": "KY"},
    ...
    "maricopa-az": {"display": "Maricopa County AZ", "raw_dir": RAW_ROOT / "maricopa-az", "raw_pattern": "parcels-extracted.csv", "lane_patterns": {"default": ["parcels-extracted.csv"], "individual-homeowner": ["parcels-extracted.csv", "residential-master.zip"], "high-equity": ["parcels-extracted.csv", "residential-master.zip", "secured-master.zip"], "entity-owned": ["parcels-extracted.csv", "commercial-master.zip", "secured-master.zip"], "vacant-land": ["parcels-extracted.csv", "secured-master.zip"]}, "default_city": "Phoenix", "state": "AZ"},
    "york-sc": {"display": "York County SC", "raw_dir": RAW_ROOT / "york-sc", "raw_pattern": "parcels.csv", "lane_patterns": {"default": ["parcels.csv"], "individual-homeowner": ["parcels.csv"], "absentee": ["parcels.csv"], "high-equity": ["parcels.csv"], "entity-owned": ["parcels.csv"], "vacant-land": ["parcels.csv"]}, "default_city": "Rock Hill", "state": "SC"},
    "cabarrus-nc": {"display": "Cabarrus County NC", "raw_dir": RAW_ROOT / "cabarrus-nc", "raw_pattern": "parcels.csv", "lane_patterns": {"default": ["parcels.csv"], "individual-homeowner": ["parcels.csv"], "absentee": ["parcels.csv"], "high-equity": ["parcels.csv"], "entity-owned": ["parcels.csv"], "vacant-land": ["parcels.csv"]}, "default_city": "Concord", "state": "NC"},
    "lancaster-sc": {"display": "Lancaster County SC", "raw_dir": RAW_ROOT / "lancaster-sc", "raw_pattern": "parcels.csv", "lane_patterns": {"default": ["parcels.csv"], "individual-homeowner": ["parcels.csv"], "absentee": ["parcels.csv"], "high-equity": ["parcels.csv"], "entity-owned": ["parcels.csv"], "vacant-land": ["parcels.csv"]}, "default_city": "Lancaster", "state": "SC"},
    "gaston-nc": {"display": "Gaston County NC", "raw_dir": RAW_ROOT / "gaston-nc", "raw_pattern": "parcels.csv", "lane_patterns": {"default": ["parcels.csv"], "individual-homeowner": ["parcels.csv"], "absentee": ["parcels.csv"], "high-equity": ["parcels.csv"], "entity-owned": ["parcels.csv"], "vacant-land": ["parcels.csv"]}, "default_city": "Gastonia", "state": "NC"},
