...
MARKETS: dict[str, dict[str, Any]] = {
    ...
    "bradley-tn": {
        "display": "Bradley County TN",
        "source": RAW_ROOT / "bradley-tn" / TODAY / "tpad-land.csv",
        "source_url": "https://assessment.cot.tn.gov/TPAD",
        "output_date": TODAY,
        "state": "TN",
        "county": "Bradley",
        "fields": {
            "vacant": ["class", "sale_vacant_improved"],
            "vacant_values": {"FARM", "AGRICULTURAL", "FOREST", "OPEN SPACE"},
            "land": ["land_market_value"],
            "building": ["improvement_value"],
            "total": ["total_market_appraisal"],
            "year": [],
            "heated": [],
            "owner": ["owner_name"],
            "acreage": ["deed_acres", "calculated_acres"],
            "parcel": ["parcel_id", "parcel_key"],
            "address": ["property_address"],
            "city": [],
            "mail_city": ["mail_city"],
            "mail_state": ["mail_state"],
            "mail_zip": ["mail_zip"],
            "land_use": ["class", "property_type"],
            "sale_date": ["sale_date"],
        },
    },
    "marion-tn": {
        "display": "Marion County TN",
        "source": RAW_ROOT / "marion-tn" / TODAY / "tpad-land.csv",
        "source_url": "https://assessment.cot.tn.gov/TPAD",
        "output_date": TODAY,
        "state": "TN",
        "county": "Marion",
