# LeadCurate — Limited-seat county property data

Source: file:///var/www/leadcurate-preview/index.html
...
| `extracted/tokens.json` | Design tokens: 17 colors, 2 fonts, 20 headings, 7 CTAs |
...
- **Colors**: #1E293B (accent), #FFFFFF (bg-light), #FAF7F2 (bg-light), #0F172A (accent), #64748B (neutral), #DFF4E8 (bg-light), #BBF7D0 (bg-light), #F5F1EB (bg-light), #D1FAE5 (bg-light), #22C55E (accent)
- **Fonts**: Inter (400,500,600,700,800,900), Playfair Display (600,700)
