...
CUSTOMER COUNTY:    Charlotte (Mecklenburg County), NC
DELIVERY DATE:      2026-06-19
LANE COUNT:         3
TOTAL RECORDS:      300
PACKAGE ID:         charlotte-nc-2026-06-19

----------------------------------------------------------------------
  WHAT'S IN THIS PACKAGE
----------------------------------------------------------------------

This folder contains your monthly County Seat delivery for Charlotte (Mecklenburg County),
NC. It is organized into 3 distinct distress lanes, each
...
----------------------------------------------------------------------
  ...
  LANE 1: Charlotte NC Open City Liens
     records delivered : 100
     filtered from    : 4,025 qualified  (source universe: 4,025)
     score range      : 122.1 - 123.07
     source           : https://data.charlottenc.gov/datasets/financial-management-system-lien-data

  LANE 2: Charlotte NC Vacant Land Specialty
     records delivered : 100
     filtered from    : 15,273 qualified  (source universe: 23,204)
     score range      : 100 - 100
     source           : https://data.charlottenc.gov/datasets/vacant-land

  LANE 3: Charlotte NC High-Value Absentee Single-Family
     records delivered : 100
     filtered from    : 47,151 qualified  (source universe: 446,213)
     score range      : 100 - 100
     source           : https://data.charlottenc.gov/datasets/parcel-look-up
...
A name that hits the Charlotte (Mecklenburg County) public record on the first of the
