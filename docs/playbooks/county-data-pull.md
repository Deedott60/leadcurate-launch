...
- **Dallas TX — Tier 3 DCAD ViewPDFs.aspx**:
  ...
  - Verified fresh run 2026-07-16 UTC: 760,654 real-property accounts, 760,654 unique canonical parcels, 140 official source columns, zero duplicate parcels. Supported lane counts are 39,123 tired landlords, 18,100 industrial/multifamily, 32,382 out-of-state owners, and 36,386 verified-vacant parcels. All four full files have zero duplicate parcel IDs and file-matched metadata. DCAD does not expose current foreclosure dockets or unpaid-tax balances, so those two lane triples remain explicitly unavailable.
